        ...
        <div className={`flex h-screen items-center justify-center`}>
            ...
            <div className={`m-10 w-full md:w-1/2 lg:w-1/3`}>
                ...
                <AuthInput
                    ...
                    obrigatorio
                />
                <button onClick={submit} className={`w-full bg-indigo-500 hover:bg-indigo-400
                ...
                <button onClick={loginGoogle} className={`w-full bg-red-500 hover:bg-red-400
                ...
                {modo === 'login' ? (
                    ...
                    <p className="mt-8">
                        ...
                        <a onClick={() => setModo('login')} className={`
                            text-blue-500 hover:text-blue-700 font-semibold cursor-pointer`}> Entre com sua conta
                        </a>
                    </p>
                )}
            </div>
